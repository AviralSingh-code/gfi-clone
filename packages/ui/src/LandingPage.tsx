import { Button, Container, Grid, Typography, createTheme, useThemeProps } from "@mui/material";
import Head from 'next/head';

export function LandingPage({userState, onSigninParent, onSignoutParent, onBrowseClickParent, onSignupParent})
{
  if(!userState)
  {
    ...
    return ( <StateTwo onBrowseClick={()=>{onBrowseClickParent();}} onSignout={()=>{onSignoutParent();}}></StateTwo> );
  }
